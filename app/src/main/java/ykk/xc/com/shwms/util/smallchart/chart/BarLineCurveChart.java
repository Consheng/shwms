package ykk.xc.com.shwms.util.smallchart.chart;
...
import ykk.xc.com.shwms.util.smallchart.animation.ChartAnimator;
import ykk.xc.com.shwms.util.smallchart.compute.ComputeXAxis;
import ykk.xc.com.shwms.util.smallchart.compute.ComputeYAxis;
import ykk.xc.com.shwms.util.smallchart.data.XAxisData;
import ykk.xc.com.shwms.util.smallchart.data.YAxisData;
import ykk.xc.com.shwms.util.smallchart.interfaces.iChart.IBarLineCurveChart;
import ykk.xc.com.shwms.util.smallchart.interfaces.iData.IBarLineCurveData;
import ykk.xc.com.shwms.util.smallchart.interfaces.iData.IXAxisData;
import ykk.xc.com.shwms.util.smallchart.interfaces.iData.IYAxisData;
import ykk.xc.com.shwms.util.smallchart.render.XAxisOffsetRender;
import ykk.xc.com.shwms.util.smallchart.render.XAxisRender;
import ykk.xc.com.shwms.util.smallchart.render.YAxisRender;
...
public abstract class BarLineCurveChart<T extends IBarLineCurveData> extends Chart<T> implements IBarLineCurveChart {
    ...
    protected IXAxisData mXAxisData = (IXAxisData) new XAxisData();
    protected IYAxisData mYAxisData = (IYAxisData) new YAxisData();
