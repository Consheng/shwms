package ykk.xc.com.shwms.util.xrecyclerview;
...
public class XRecyclerView extends RecyclerView {
    ...
    private static final float DRAG_RATE = 3; //减阻率
    ...
    private void init() {
        ...
        mFootView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mRefreshHeader != null && mRefreshHeader.getState() < ArrowRefreshHeader.STATE_REFRESHING && mLoadingListener != null) {
    ...
    public void loadMoreComplete(boolean isSuccess) {
        ...
        if (mFootView instanceof LoadingMoreFooter) {
            if (isSuccess) {
                ...
                ((LoadingMoreFooter) mFootView).setState(LoadingMoreFooter.STATE_FAILURE);
            }
        } else {
            mFootView.setVisibility(View.GONE);
        }
    ...
    public void reset(boolean isSuccess) {
        setNoMore(false);
        loadMoreComplete(isSuccess);
        refreshComplete(isSuccess);
    }

    public void refreshComplete(boolean isSuccess) {
        mRefreshHeader.refreshComplete(isSuccess);
        setNoMore(false);
    }
    ...
    public void setLoadingMoreEnabled(boolean enabled) {
        ...
        if (!enabled) {
            ...
            if (mFootView instanceof LoadingMoreFooter) {
                ((LoadingMoreFooter) mFootView).setState(LoadingMoreFooter.STATE_NORMAL);
            }
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                mRefreshHeader.refreshUpdatedAtValue();
