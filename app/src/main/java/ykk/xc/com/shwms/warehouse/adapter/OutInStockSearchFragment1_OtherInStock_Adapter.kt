...
class OutInStockSearchFragment1_OtherInStock_Adapter(private val context: Activity, datas: List<ICStockBill_App>) : BaseArrayRecyclerAdapter<ICStockBill_App>(datas) {
