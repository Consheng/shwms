...
class OutInStockSearchFragment8_ProdTransfer_Adapter(private val context: Activity, datas: List<ICStockBill_Old>) : BaseArrayRecyclerAdapter<ICStockBill_Old>(datas) {
