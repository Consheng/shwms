...
import kotlinx.android.synthetic.main.pur_in_stock_fragment3.*
...
import ykk.xc.com.shwms.purchase.adapter.Pur_InStock_Fragment3_Adapter
 ...
 * 作者：ykk
 */
class Pur_InStock_Fragment3 : BaseFragment() {
    ...
    private var mAdapter: Pur_InStock_Fragment3_Adapter? = null
    ...
    private class MyHandler(activity: Pur_InStock_Fragment3) : Handler() {
        private val mActivity: WeakReference<Pur_InStock_Fragment3>
...
//                        }
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.pur_in_stock_fragment3, container, false)
    }
    ...
    override fun initView() {
        ...
        mAdapter = Pur_InStock_Fragment3_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : Pur_InStock_Fragment3_Adapter.MyCallBack {
