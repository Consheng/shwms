...
import ykk.xc.com.shwms.basics.adapter.MoreBatchInputAdapter
...
class MoreBatchInputDialog : BaseDialogActivity() {
    ...
    private val listDatas = ArrayList<ICStockBillEntryBarcode_Old>()
    ...
    override fun initView() {
        ...
        mAdapter!!.setCallBack(object : MoreBatchInputAdapter.MyCallBack {
            override fun onDelete(entity: ICStockBillEntryBarcode_Old, position: Int) {
...
//                    context.finish()
    ...
    fun addRow() : Boolean {
        ...
        val m = ICStockBillEntryBarcode_Old()
