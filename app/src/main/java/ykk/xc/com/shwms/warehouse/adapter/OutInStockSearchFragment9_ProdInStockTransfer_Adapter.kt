...
class OutInStockSearchFragment9_ProdInStockTransfer_Adapter(private val context: Activity, datas: List<ICStockBill_Old>) : BaseArrayRecyclerAdapter<ICStockBill_Old>(datas) {
