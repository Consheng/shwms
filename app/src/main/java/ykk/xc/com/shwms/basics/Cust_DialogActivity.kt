...
import ykk.xc.com.shwms.basics.adapter.Cust_DialogAdapter
 ...
 * 选择部门dialog
 */
class Cust_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<Customer_App>()
    private var mAdapter: Cust_DialogAdapter? = null
    private val okHttpClient = OkHttpClient()
    private var limit = 1
    private var isRefresh: Boolean = false
    private var isLoadMore: Boolean = false
    private var isNextPage: Boolean = false
    private val flag: Int = 0 // 加载不同数据的标识
    private val departmentProperty: Int = 0 // 属性：1070-车间,1071-非车间

    // 消息处理
    private val mHandler = MyHandler(this)

    private class MyHandler(activity: Cust_DialogActivity) : Handler() {
        private val mActivity: WeakReference<Cust_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, Customer_App::class.java)
    ...
    override fun initView() {
        ...
        mAdapter = Cust_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("customer/findListByPage")
