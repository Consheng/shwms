...
class OutInStockSearchFragment7_PurReceiveQC_Adapter(private val context: Activity, datas: List<ICStockBill_Old>) : BaseArrayRecyclerAdapter<ICStockBill_Old>(datas) {
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: ICStockBill_Old, pos: Int) {
        ...
        tv_suppName?.text = entity.supplier.fname
