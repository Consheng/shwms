...
class MainTabFragment0 : BaseFragment(), IDownloadContract.View, XRecyclerView.LoadingListener {
    ...
    companion object {
        ...
        private val CLOSE = 202
        private val UNCLOSE = 502
...
//            } else {
                ...
                when (listDatas[pos - 1].missionType) {
                    1 -> show(Prod_Transfer_MainActivity::class.java, bundle)
                    2 -> show(Prod_Transfer2_MainActivity::class.java, bundle)
                }
//            }
        }
...
//                show(Sal_PickGoods_MainActivity::class.java, bundle)
    ...
    private fun pop_missionType(v: View) {
        ...
        val click = View.OnClickListener { v ->
            when (v.id) {
                R.id.tv1 -> {
                    tv_missionType.text = "锁库成品调拨任务"
                    missionType = 1
                }
                R.id.tv2 -> {
                    tv_missionType.text = "生产材料调拨任务"
                    missionType = 2
                }
            }
