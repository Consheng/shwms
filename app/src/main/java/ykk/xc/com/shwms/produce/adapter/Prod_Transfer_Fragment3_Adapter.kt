...
class Prod_Transfer_Fragment3_Adapter(private val context: Activity, datas: List<ICStockBillEntry_Old>) : BaseArrayRecyclerAdapter<ICStockBillEntry_Old>(datas) {
    private val df = DecimalFormat("#.######")
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.prod_transfer_fragment3_item
    }
