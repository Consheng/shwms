...
class Prod_Transfer2_Fragment3_Adapter(private val context: Activity, datas: List<ICStockBillEntry_Old>) : BaseArrayRecyclerAdapter<ICStockBillEntry_Old>(datas) {
...
//        view_del.setOnClickListener(click)
    ...
    interface MyCallBack {
        ...
        fun onCheck(v :View, entity: ICStockBillEntry_Old, position: Int)
    }
