...
import ykk.xc.com.shwms.warehouse.adapter.ICInvBackup_Sel_Material_Fragment1Adapter
 ...
 * 作者：ykk
 */
class ICInvBackup_Sel_Material_Fragment1 : BaseFragment(), XRecyclerView.LoadingListener {
    companion object {
    ...
    private class MyHandler(activity: ICInvBackup_Sel_Material_Fragment1) : Handler() {
        private val mActivity: WeakReference<ICInvBackup_Sel_Material_Fragment1>
