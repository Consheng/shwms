...
import ykk.xc.com.shwms.warehouse.adapter.OutInStockSearchFragment10_XSJH_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment10_XSJH : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment10_XSJH_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment10_XSJH) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment10_XSJH>
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment10_XSJH_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment10_XSJH_Adapter.MyCallBack {
