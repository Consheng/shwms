...
import ykk.xc.com.shwms.purchase.Pur_Receive_InStock_MainActivity
...
import ykk.xc.com.shwms.warehouse.adapter.OutInStockSearchFragment6_PurReceiveInStock_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment6_PurReceiveInStock : BaseFragment() {
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment6_PurReceiveInStock) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment6_PurReceiveInStock>
