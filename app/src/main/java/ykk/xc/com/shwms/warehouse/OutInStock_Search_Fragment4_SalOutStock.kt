...
import ykk.xc.com.shwms.warehouse.adapter.OutInStockSearchFragment4_SalOutStock_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment4_SalOutStock : BaseFragment() {
    companion object {
    ...
    private var mAdapter: OutInStockSearchFragment4_SalOutStock_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment4_SalOutStock) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment4_SalOutStock>
...
//                        m.toasts("很抱歉，没有找到数据！")
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment4_SalOutStock_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment4_SalOutStock_Adapter.MyCallBack {
