...
import ykk.xc.com.shwms.basics.adapter.ICItemStructure_DialogAdapter
import ykk.xc.com.shwms.bean.ICItemStructure
 ...
 * 选择产品结构dialog
 */
class ICitemStructure_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<ICItemStructure>()
    private var mAdapter: ICItemStructure_DialogAdapter? = null
    ...
    private class MyHandler(activity: ICitemStructure_DialogActivity) : Handler() {
        private val mActivity: WeakReference<ICitemStructure_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, ICItemStructure::class.java)
    ...
    override fun initView() {
        ...
        mAdapter = ICItemStructure_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("iCItemStructure/findListByPage")
