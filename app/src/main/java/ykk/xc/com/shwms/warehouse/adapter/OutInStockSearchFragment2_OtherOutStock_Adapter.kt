...
class OutInStockSearchFragment2_OtherOutStock_Adapter(private val context: Activity, datas: List<ICStockBill_App>) : BaseArrayRecyclerAdapter<ICStockBill_App>(datas) {
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: ICStockBill_App, pos: Int) {
        ...
        if(entity.department != null) {
            tv_deptName.text = Html.fromHtml("部门:&nbsp;<font color='#000000'>"+ entity.department.fname +"</font>")
