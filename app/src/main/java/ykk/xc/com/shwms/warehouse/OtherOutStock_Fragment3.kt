...
import ykk.xc.com.shwms.warehouse.adapter.OtherOutStockFragment3Adapter
...
class OtherOutStock_Fragment3 : BaseFragment() {
    ...
    private class MyHandler(activity: OtherOutStock_Fragment3) : Handler() {
        private val mActivity: WeakReference<OtherOutStock_Fragment3>
    ...
    override fun initView() {
        ...
        mAdapter = OtherOutStockFragment3Adapter(mContext!!, checkDatas)
