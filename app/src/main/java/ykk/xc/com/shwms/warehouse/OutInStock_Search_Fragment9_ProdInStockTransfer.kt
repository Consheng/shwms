...
import ykk.xc.com.shwms.produce.Prod_Transfer2_MainActivity
...
import ykk.xc.com.shwms.warehouse.adapter.OutInStockSearchFragment9_ProdInStockTransfer_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment9_ProdInStockTransfer : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment9_ProdInStockTransfer_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment9_ProdInStockTransfer) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment9_ProdInStockTransfer>
...
//                        }
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment9_ProdInStockTransfer_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment9_ProdInStockTransfer_Adapter.MyCallBack {
