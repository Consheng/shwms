 ...
 * 锁库成品调拨
 */
class Prod_Transfer_MainActivity : BaseActivity() {

    private val REFRESH = 10

    private val context = this
    private val TAG = "Prod_Transfer_MainActivity"
    private var curRadio: View? = null
    private var curRadioName: TextView? = null
    var isChange: Boolean = false // 返回的时候是否需要判断数据是否保存了

    val fragment1 = Prod_Transfer_Fragment1()
    val fragment2 = Prod_Transfer_Fragment2()
    val fragment3 = Prod_Transfer_Fragment3()
    var isMainSave = false // 主表信息是否保存
    var pageId = 0

    override fun setLayoutResID(): Int {
        return R.layout.prod_transfer_main;
    }
