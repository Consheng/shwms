...
import kotlinx.android.synthetic.main.ab_express_company_dialog.*
import okhttp3.*
import ykk.xc.com.shwms.R
import ykk.xc.com.shwms.basics.adapter.ExpressCompany_DialogAdapter
 ...
 * 选择部门dialog
 */
class ExpressCompany_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<ExpressCompany>()
    private var mAdapter: ExpressCompany_DialogAdapter? = null
    ...
    private class MyHandler(activity: ExpressCompany_DialogActivity) : Handler() {
        private val mActivity: WeakReference<ExpressCompany_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, ExpressCompany::class.java)
    ...
    override fun setLayoutResID(): Int {
        return R.layout.ab_express_company_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = ExpressCompany_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("expressCompany/findListPage")
