...
import ykk.xc.com.shwms.produce.Prod_Transfer_MainActivity
...
import ykk.xc.com.shwms.warehouse.adapter.OutInStockSearchFragment8_ProdTransfer_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment8_ProdTransfer : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment8_ProdTransfer_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment8_ProdTransfer) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment8_ProdTransfer>
...
//                        }
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment8_ProdTransfer_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment8_ProdTransfer_Adapter.MyCallBack {
