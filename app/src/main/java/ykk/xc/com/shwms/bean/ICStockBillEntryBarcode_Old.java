 ...
 *
 */
public class ICStockBillEntryBarcode_Old implements Serializable {
	...
	private int againUse; // 是否再次使用，场景，当外购入库保存为1，仓库收料操作为0，一个条码在外购入库用完还可以在仓库收料操作页面扫码，之后就不能扫
	private String createDate; // 创建日期
	private String createUserName; // 创建人名称
	private String billType; // 主表的单据类型

	public ICStockBillEntryBarcode_Old() {
		super();
	}
