...
import kotlinx.android.synthetic.main.ware_icinvbackup_repeat_main.*
 ...
 * 作者：ykk
 */
class ICInvBackup_Repeat_MainActivity : BaseActivity() {

    private val context = this
    private val TAG = "ICInvBackupMainActivity"
    private var curRadio: View? = null
    var isChange: Boolean = false // 返回的时候是否需要判断数据是否保存了
    private val fragment1 = ICInvBackup_Repeat_Fragment1()
    private var pageId = 0

    override fun setLayoutResID(): Int {
        return R.layout.ware_icinvbackup_repeat_main;
    }
