...
import kotlinx.android.synthetic.main.ab_icitem_classes_dialog.*
import okhttp3.*
import ykk.xc.com.shwms.R
import ykk.xc.com.shwms.basics.adapter.ICItemClasses_DialogAdapter
import ykk.xc.com.shwms.bean.ICItemClasses
 ...
 * 选择产品类别dialog
 */
class ICitemClasses_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<ICItemClasses>()
    private var mAdapter: ICItemClasses_DialogAdapter? = null
    ...
    private class MyHandler(activity: ICitemClasses_DialogActivity) : Handler() {
        private val mActivity: WeakReference<ICitemClasses_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, ICItemClasses::class.java)
    ...
    override fun setLayoutResID(): Int {
        return R.layout.ab_icitem_classes_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = ICItemClasses_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("iCItemClasses/findListByPage")
