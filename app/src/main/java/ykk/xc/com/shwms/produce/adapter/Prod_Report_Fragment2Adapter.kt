...
import ykk.xc.com.shwms.bean.ProdReport
...
class Prod_Report_Fragment2Adapter(private val context: Activity, datas: List<ProdReport>) : BaseArrayRecyclerAdapter<ProdReport>(datas) {
    private val df = DecimalFormat("#.######")
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.prod_report_fragment2_item
    }
