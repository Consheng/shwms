...
import kotlinx.android.synthetic.main.ab_stock_area_dialog.*
import okhttp3.*
import ykk.xc.com.shwms.R
import ykk.xc.com.shwms.basics.adapter.StockArea_DialogAdapter
 ...
 * 选择库区 dialog
 */
class StockArea_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<StockArea>()
    private var mAdapter: StockArea_DialogAdapter? = null
    ...
    private class MyHandler(activity: StockArea_DialogActivity) : Handler() {
        private val mActivity: WeakReference<StockArea_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, StockArea::class.java)
    ...
    override fun initView() {
        ...
        mAdapter = StockArea_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("stockArea/findListByPage")
