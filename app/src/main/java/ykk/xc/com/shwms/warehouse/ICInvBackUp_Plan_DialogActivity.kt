...
import kotlinx.android.synthetic.main.ware_icinvbackup_plan_dialog.*
import okhttp3.*
import ykk.xc.com.shwms.R
import ykk.xc.com.shwms.bean.ICInvBackUp_Plan
...
import ykk.xc.com.shwms.warehouse.adapter.ICInvBackUp_Plan_DialogAdapter
 ...
 * 选择Wms盘点方案dialog
 */
class ICInvBackUp_Plan_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<ICInvBackUp_Plan>()
    private var mAdapter: ICInvBackUp_Plan_DialogAdapter? = null
    ...
    private class MyHandler(activity: ICInvBackUp_Plan_DialogActivity) : Handler() {
        private val mActivity: WeakReference<ICInvBackUp_Plan_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, ICInvBackUp_Plan::class.java)
    ...
    override fun setLayoutResID(): Int {
        return R.layout.ware_icinvbackup_plan_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = ICInvBackUp_Plan_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("icInvBackUp_Plan/findList")
        val formBody = FormBody.Builder()
                .add("fname", getValues(et_search).trim { it <= ' ' })
                .add("status",status)
