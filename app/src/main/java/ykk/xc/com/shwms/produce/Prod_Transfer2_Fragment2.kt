...
import kotlinx.android.synthetic.main.prod_transfer2_fragment2.*
import okhttp3.*
 ...
 * 作者：ykk
 */
class Prod_Transfer2_Fragment2 : BaseFragment() {
    ...
    private class MyHandler(activity: Prod_Transfer2_Fragment2) : Handler() {
        private val mActivity: WeakReference<Prod_Transfer2_Fragment2>
...
//                                }
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.prod_transfer2_fragment2, container, false)
    }
...
//            entry.fprice = it.fprice
            if(!it.icItem.snManager.equals("Y") && !it.icItem.batchManager.equals("Y")) { // 没启用批次号和序列号的，实发数=应发数
                entry.fqty = it.useableQty
            }
