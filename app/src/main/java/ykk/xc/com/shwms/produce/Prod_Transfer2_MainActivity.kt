 ...
 * 生产材料调拨
 */
class Prod_Transfer2_MainActivity : BaseActivity() {

    private val REFRESH = 10

    private val context = this
    private val TAG = "Prod_Transfer2_MainActivity"
    private var curRadio: View? = null
    private var curRadioName: TextView? = null
    var isChange: Boolean = false // 返回的时候是否需要判断数据是否保存了

    val fragment1 = Prod_Transfer2_Fragment1()
    val fragment2 = Prod_Transfer2_Fragment2()
