 ...
 * 作者：ykk
 */
class Prod_InStock_MainActivity : BaseActivity() {
    ...
    val fragment1 = Prod_InStock_Fragment1()
    val fragment2 = Prod_InStock_Fragment2()
    val fragment3 = Prod_InStock_Fragment3()
    var isMainSave = false // 主表信息是否保存
    var pageId = 0

    override fun setLayoutResID(): Int {
        return R.layout.prod_in_stock_main;
    }
