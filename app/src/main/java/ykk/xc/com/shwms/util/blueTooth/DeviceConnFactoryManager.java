package ykk.xc.com.shwms.util.blueTooth;
...
import ykk.xc.com.shwms.comm.MyApplication;
...
public class DeviceConnFactoryManager {
    ...
    public static void closeAllPort() {
        for (DeviceConnFactoryManager deviceConnFactoryManager : deviceConnFactoryManagers) {
            if (deviceConnFactoryManager != null) {
                LogUtil.e(TAG, "cloaseAllPort() id -> " + deviceConnFactoryManager.id);
    ...
    public void sendDataImmediately(final Vector<Byte> data) {
        ...
        try {
            LogUtil.e(TAG, "data -> " + new String(com.gprinter.utils.Utils.convertVectorByteTobytes(data), "gb2312"));
