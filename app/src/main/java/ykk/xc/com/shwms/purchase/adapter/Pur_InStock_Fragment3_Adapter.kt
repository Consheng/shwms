...
class Pur_InStock_Fragment3_Adapter(private val context: Activity, datas: List<ICStockBillEntry_Old>) : BaseArrayRecyclerAdapter<ICStockBillEntry_Old>(datas) {
    private val df = DecimalFormat("#.######")
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.pur_in_stock_fragment3_item
    }
