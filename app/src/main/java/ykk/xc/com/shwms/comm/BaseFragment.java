...
import ykk.xc.com.shwms.basics.PublicInputDialog;
import ykk.xc.com.shwms.basics.PublicInputDialog2;
import ykk.xc.com.shwms.bean.User;
import ykk.xc.com.shwms.util.JsonUtil;
import ykk.xc.com.shwms.util.LoadingDialog;
...
//		return edit.getText().toString();
	 ...
	 * @param bundle  传值
	 */
	public void showForResult(Fragment fragment, Class<?> context2 , int code , Bundle bundle){
		Intent intent = new Intent();
		intent.setClass(getActivity(), context2);
