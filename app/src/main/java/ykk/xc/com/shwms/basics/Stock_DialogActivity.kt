...
import kotlinx.android.synthetic.main.ab_stock_dialog.*
import okhttp3.*
import ykk.xc.com.shwms.R
import ykk.xc.com.shwms.basics.adapter.Stock_DialogAdapter
 ...
 * 选择仓库dialog
 */
class Stock_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<Stock_App>()
    private var mAdapter: Stock_DialogAdapter? = null
    ...
    private class MyHandler(activity: Stock_DialogActivity) : Handler() {
        private val mActivity: WeakReference<Stock_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, Stock_App::class.java)
    ...
    override fun initView() {
        ...
        mAdapter = Stock_DialogAdapter(context, listDatas)
