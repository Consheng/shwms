...
import okhttp3.*
import ykk.xc.com.shwms.bean.SystemSet
import ykk.xc.com.shwms.bean.User
import ykk.xc.com.shwms.comm.BaseActivity
import ykk.xc.com.shwms.comm.Comm
import ykk.xc.com.shwms.comm.Consts
import ykk.xc.com.shwms.entrance.MainTabFragmentActivity
import ykk.xc.com.shwms.entrance.Main_Supplier_Activity
    ...
    private fun run_appLogin() {
        ...
        okHttpClient.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                LogUtil.e("run_appLogin --> onResponse", result)
                mHandler.sendMessage(msg)

                //获取session的操作，session放在cookie头，且取出后含有“；”，取出后为下面的 s （也就是jsesseionid）
                val headers = response.headers()
                LogUtil.e("info_headers", "header $headers")
                val cookies = headers.values("Set-Cookie")
                val session = cookies[0]
                LogUtil.e("info_cookies", "onResponse-size: $cookies")
