...
import kotlinx.android.synthetic.main.ab_box_dialog.*
import okhttp3.*
import ykk.xc.com.shwms.R
import ykk.xc.com.shwms.basics.adapter.Box_DialogAdapter
import ykk.xc.com.shwms.bean.Box
 ...
 * 选择部门dialog
 */
class Box_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<Box>()
    private var mAdapter: Box_DialogAdapter? = null
    ...
    private class MyHandler(activity: Box_DialogActivity) : Handler() {
        private val mActivity: WeakReference<Box_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, Box::class.java)
    ...
    override fun initView() {
        ...
        mAdapter = Box_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("box/findListByParam")
        val formBody = FormBody.Builder()
                .add("NameAndSize", getValues(et_search).trim { it <= ' ' })
