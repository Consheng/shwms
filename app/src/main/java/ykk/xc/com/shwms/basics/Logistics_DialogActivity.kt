...
import kotlinx.android.synthetic.main.ab_logistics_dialog.*
import okhttp3.*
import ykk.xc.com.shwms.R
import ykk.xc.com.shwms.basics.adapter.Logistics_DialogAdapter
import ykk.xc.com.shwms.bean.Logistics
 ...
 * 选择物流公司dialog
 */
class Logistics_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<Logistics>()
    private var mAdapter: Logistics_DialogAdapter? = null
    ...
    private class MyHandler(activity: Logistics_DialogActivity) : Handler() {
        private val mActivity: WeakReference<Logistics_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, Logistics::class.java)
    ...
    override fun setLayoutResID(): Int {
        return R.layout.ab_logistics_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = Logistics_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("logistics/findListByParam")
