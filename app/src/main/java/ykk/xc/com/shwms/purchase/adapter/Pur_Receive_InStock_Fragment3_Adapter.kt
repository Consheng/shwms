...
class Pur_Receive_InStock_Fragment3_Adapter(private val context: Activity, datas: List<ICStockBillEntry_Old>) : BaseArrayRecyclerAdapter<ICStockBillEntry_Old>(datas) {
