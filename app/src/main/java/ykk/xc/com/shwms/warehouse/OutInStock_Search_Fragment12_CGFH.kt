...
import ykk.xc.com.shwms.warehouse.adapter.OutInStockSearchFragment12_CGFH_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment12_CGFH : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment12_CGFH_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment12_CGFH) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment12_CGFH>
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment12_CGFH_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment12_CGFH_Adapter.MyCallBack {
