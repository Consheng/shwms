...
import ykk.xc.com.shwms.bean.pur.POInStockEntry
...
//                        m.poInStockEntryList = list
    ...
    override fun initData() {
        ...
        icStockBill.billType = "CGSHRK_BTOR" // 采购入库退货
        icStockBill.ftranType = 0
        icStockBill.frob = -1
...
//        if(poInStockEntryList == null) {
//            Comm.showWarnDialog(mContext, "请扫描收料通知单条码！")
//            return false;
//        }
