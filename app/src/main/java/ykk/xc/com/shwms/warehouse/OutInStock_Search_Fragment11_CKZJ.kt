...
import ykk.xc.com.shwms.warehouse.adapter.OutInStockSearchFragment11_CKZJ_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment11_CKZJ : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment11_CKZJ_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment11_CKZJ) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment11_CKZJ>
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment11_CKZJ_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment11_CKZJ_Adapter.MyCallBack {
