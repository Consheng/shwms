...
import ykk.xc.com.shwms.warehouse.adapter.OutInStockSearchFragment16_ZYDB_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment16_ZYDB : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment16_ZYDB_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment16_ZYDB) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment16_ZYDB>
...
//                        m.toasts("很抱歉，没有找到数据！")
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment16_ZYDB_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment16_ZYDB_Adapter.MyCallBack {
