...
import ykk.xc.com.shwms.produce.Prod_InStock_MainActivity
...
import ykk.xc.com.shwms.warehouse.adapter.OutInStockSearchFragment5_ProdInStock_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment5_ProdInStock : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment5_ProdInStock_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment5_ProdInStock) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment5_ProdInStock>
...
//                        m.toasts("很抱歉，没有找到数据！")
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment5_ProdInStock_Adapter(mContext!!, checkDatas)
