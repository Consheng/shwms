...
import ykk.xc.com.shwms.warehouse.adapter.OutInStockSearchFragment7_PurReceiveQC_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment7_PurReceiveQC : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment7_PurReceiveQC_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment7_PurReceiveQC) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment7_PurReceiveQC>
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment7_PurReceiveQC_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment7_PurReceiveQC_Adapter.MyCallBack {
