...
import kotlinx.android.synthetic.main.prod_transfer2_fragment1.*
...
class Prod_Transfer2_Fragment1 : BaseFragment() {
    ...
    var icStockBill = ICStockBill_Old() // 保存的对象
    ...
    private class MyHandler(activity: Prod_Transfer2_Fragment1) : Handler() {
        private val mActivity: WeakReference<Prod_Transfer2_Fragment1>
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    ...
                    FIND_ICSTOCKBILL -> { // 查询主表信息 成功
                        val icsBill = JsonUtil.strToObject(msgObj, ICStockBill_Old::class.java)
    ...
    fun setICStockBill(m : ICStockBill_Old) {
        icStockBill.id = m.id
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.prod_transfer2_fragment1, container, false)
    }
    ...
    override fun initData() {
        ...
        icStockBill.billType = "SCCLDB" // 生产材料调拨
