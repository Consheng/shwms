...
import kotlinx.android.synthetic.main.ab_container_dialog.*
import okhttp3.*
import ykk.xc.com.shwms.R
import ykk.xc.com.shwms.basics.adapter.Container_DialogAdapter
import ykk.xc.com.shwms.bean.Container
 ...
 * 选择容器 dialog
 */
class Container_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<Container>()
    private var mAdapter: Container_DialogAdapter? = null
    ...
    private class MyHandler(activity: Container_DialogActivity) : Handler() {
        private val mActivity: WeakReference<Container_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, Container::class.java)
    ...
    override fun setLayoutResID(): Int {
        return R.layout.ab_container_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = Container_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("container/findListByPage")
        val formBody = FormBody.Builder()
                .add("fnumber", getValues(et_search).trim { it <= ' ' })
                .add("stockPositionId", stockId.toString())
