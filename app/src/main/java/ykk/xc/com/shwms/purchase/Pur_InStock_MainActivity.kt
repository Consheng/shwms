 ...
 * 作者：ykk
 */
class Pur_InStock_MainActivity : BaseActivity() {
    ...
    val fragment1 = Pur_InStock_Fragment1()
    val fragment2 = Pur_InStock_Fragment2()
    val fragment3 = Pur_InStock_Fragment3()
//    val fragment4 = Pur_InStock_Fragment4()
    var isMainSave = false // 主表信息是否保存
    var pageId = 0

    override fun setLayoutResID(): Int {
        return R.layout.pur_in_stock_main;
    }
