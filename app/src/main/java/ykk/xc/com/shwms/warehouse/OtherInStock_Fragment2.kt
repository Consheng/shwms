...
import kotlinx.android.synthetic.main.ware_other_in_stock_fragment2.*
import okhttp3.*
...
//                        m.toasts("保存成功✔")
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.ware_other_in_stock_fragment2, container, false)
    }
    ...
    fun onViewClicked(view: View) {
        when (view.id) {
            ...
            R.id.tv_batchNo -> { // 批次号
                ...
                bundle.putSerializable("icstockBillEntry_Barcodes", icstockBillEntry.icstockBillEntryBarcodes as Serializable)
...
//        }
        ...
        /*if(icstockBillEntry.icItem.isQualityPeriodManager == 1 && icstockBillEntry.fkfPeriod == 0) {
...
//        et_containerCode!!.setOnClickListener(click)
    ...
    private fun showLocalStockGroup() {
        ...
        if(spfStock.contains("BIND_OTHER_IN_STOCK")) {
            stock = showObjectByXml(Stock_App::class.java, "BIND_OTHER_IN_STOCK", saveOther)
        }
        if(spfStock.contains("BIND_OTHER_IN_STOCKPOS")) {
            stockPlace = showObjectByXml(StockPlace_App::class.java, "BIND_OTHER_IN_STOCKPOS", saveOther)
        }
        getStockGroup(null)
    }
